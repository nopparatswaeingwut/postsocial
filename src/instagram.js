...
if (x == 1) {
 ...
 login();
  ...
  (async () => {
    ...
    const videoPath = "C:/Users/DELL/Desktop/social-api/video/Video1m.mp4";
    // const coverPath = "C:/Users/DELL/Desktop/instagram/image/JPG.jpg";
    const coverPath = "C:/Users/DELL/Desktop/social-api/image/PNG.png";
...
// test = async () => {
//   await login();
//   const userID = await ig.user.getIdByUsername('npr_ww');
